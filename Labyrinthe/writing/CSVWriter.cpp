...
CSVWriter::CSVWriter(std::string filename, int gameTime, int collisionNumber, float stressAverage) {
...
void CSVWriter::writeLine() {
    ...
    //Ecriture
    std::string str = "\n" + std::to_string(newUserID) + ";" + date + ";" + std::to_string(this->gameTime) + ";" + std::to_string(this->collisionNumber) + ";" + std::to_string(this->stressAverage);
    out << str;
}
