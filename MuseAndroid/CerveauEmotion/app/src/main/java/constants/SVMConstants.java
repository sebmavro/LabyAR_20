...
public final class SVMConstants {
    ...
    // Bandpass Filter
    public final static double SAMPLE_RATE = 256;
//    public final static int WINDOW_SHIFT2 = (int) (WINDOW_SIZE * (OVER_LAP /100.0)); //256
    ...
    public final static double OVER_LAP = 50;
    public final static int WINDOW_SHIFT = (int) (WINDOW_SIZE * (OVER_LAP / 100.0));

    public final static double maFeat = 1;
    public final static double maStep = 1;

    public final static double[] BAND = {1, 4, 8, 12, 18, 30, 45};
    public final static int NUM_BAND = BAND.length - 1;
    public final static int N_START_BAND = 1;
